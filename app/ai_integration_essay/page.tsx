...
export default function PdfDisplayPage() {
  ...
  const filePath: string = '/AI_Integration.txt'; // Path updated as per your request

  return (
    <main className="flex flex-col items-center justify-center min-h-screen p-8 bg-gray-50">
      <h2 className="mb-4 text-3xl font-extrabold text-gray-800 text-center">AI Integration Essay</h2>
      <iframe
